          ...
          <div className='relative'>
            <div className='flex gap-8 overflow-x-auto pb-8 scrollbar-hide scroll-smooth snap-x snap-mandatory'>
              {events.map((event) => (
                ...
                >
                  {/* Card Container */}
                  <div className='relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:bg-white/10 hover:border-white/20 transition-all duration-700 hover:shadow-2xl hover:shadow-black/50'>
                    ...
                    <div className='relative aspect-[3/4] overflow-hidden'>
                      ...
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${event.color.primary} opacity-0 group-hover:opacity-20 transition-opacity duration-700`}
                      ></div>
                      ...
                      <div className='absolute bottom-0 left-0 right-0 p-6'>
                        <div className='relative'>
                          <h3 className='absolute bottom-0 text-white text-xl leading-tight transition-transform duration-500 ease-out group-hover:-translate-y-17'>
                            {event.title}
                          </h3>
                          <div className='space-y-3 mt-4 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out'>
                        ...
                        {/* Elegant CTA */}
                        <button className='group/btn w-full bg-black/30 backdrop-blur-xl border border-white/10 rounded-2xl py-1 text-black font-light hover:bg-black/20 hover:border-white/30 transition-all duration-500 hover:shadow-xl mt-6'>
                          <div className='flex items-center justify-center gap-3'>
                            <span className='group-hover/btn:tracking-wider transition-all duration-300 text-white'>
                              Explore Event
                            </span>
                            <div className='w-2 h-2 border-r border-b border-white/70 transform rotate-[-45deg] group-hover/btn:translate-x-1 transition-transform duration-300'></div>
                          </div>
                        </button>
                      </div>
                    </div>
