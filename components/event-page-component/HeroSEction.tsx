  ...
  return (
    ...
    >
      ...
      <div className='relative z-30 lg:sm:px-6'>
        <div className='bg-black flex flex-col items-center justify-center h-[18rem] w-full lg:max-w-[36rem] mx-auto py-8 sm:py-12 border border-white/10'>
          <h1 className='text-base sm:text-lg md:text-2xl lg:text-4xl font-bold text-center leading-tight mb-6 sm:mb-8 tracking-tight max-w-[90%] sm:max-w-4xl bg-gradient-to-b from-white to-white/80 bg-clip-text text-transparent'>
          ...
          <div className='flex flex-col sm:flex-row gap-3 sm:gap-4'>
            ...
            <button className='px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/5 text-white font-semibold border border-white/20 hover:bg-white/10 hover:border-white/40 transition-all duration-300 hover:scale-105 backdrop-blur-sm'>
              Get a Demo
            </button>
          </div>
        </div>
