...
const steps: Step[] = [
  {
    ...
    content: (
      <div className='space-y-2'>
        ...
        <button className='flex items-center gap-1 px-3 py-1 bg-teal-400 text-black text-xs rounded-full'>
  ...
  },
  {
    ...
    icon: <ArrowRight className='w-4 h-4 text-teal-400' />,
    content: (
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
        ...
        <button className='px-3 py-1 bg-orange-400 text-black text-xs rounded-full'>
          Smart Transfer
        </button>
      </div>
    ),
